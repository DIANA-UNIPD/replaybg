...
class Vettoretti19CGM(Sensor):
    ...
    Attributes
    ----------
    cgm_error_parameters : numpy.ndarray
        Array of the sampled CGM error-model parameters.
    output_noise_sd : float
        Output standard deviation of the CGM error model (mg/dl).
    ekm1 : float
        Memory term for the colored noise, e(k-1).
    ekm2 : float
        Memory term for the colored noise, e(k-2).
    ...
    measure(value, past_values, t):
        Produces a CGM measurement of the model output.
    """
    ...
    def measure(self, value, past_values, t):
        """Provides a CGM measure using the model of Vettoretti et al., Sensors, 2019.
        ...
        past_values : numpy.ndarray
            The series of past interstitial glucose concentrations (mg/dl).
        t : float
